...
> 横轴是 4 类标签，纵轴是 Amazon 卖家工作流的 9 个环节。✓ 表示该交叉象限有合格 skill；点击纵轴跳转到分类列表。
...
* [amazon-product-search](https://github.com/luotwo/amazon-product-search) — Sorftime MCP 数据 → 飞书多维表 + Dashboard 可视化 🅰️🪶🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
...
* [BSC-SIF-Amazon-keyword-database](https://github.com/luotwo/BSC-SIF-Amazon-keyword-database) — SIF MCP 关键词数据库 skill，飞书结构化交付 🅰️🪶🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
* [BSC-Amazon-sif-keyword-lark-builder](https://github.com/luotwo/BSC-Amazon-sif-keyword-lark-builder) — Sif 关键词 Excel → Lark 文档/多维表/Dashboard 🅰️🪶🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
...
* [amazon-competitor-monitor](https://github.com/WaytoAIC/amazon-competitor-monitor) — Amazon 竞品监控 Skill，含 ASIN / seller / brand 追踪 🅰️🇨🇳🆓 _By [@WaytoAIC](https://github.com/WaytoAIC)_
...
* [ecommerce-content-compliance-review](https://github.com/WaytoAIC/ecommerce-content-compliance-review) — 跨境电商内容合规审核 Skill 🅰️🇨🇳🆓 _By [@WaytoAIC](https://github.com/WaytoAIC)_
...
* [BSC-amazon-SIF-Tool](https://github.com/luotwo/BSC-amazon-SIF-Tool) — 用 SIF MCP 分析 ASIN 流量/广告/关键词/销量并发飞书 🅰️🪶🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
* [Amazon-Operations-Analysis-Dashboard](https://github.com/luotwo/Amazon-Operations-Analysis-Dashboard) — Sorftime × Claude Code 智能运营诊断 + 类目机会导航 🅰️🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
...
* [BSC-amazon-advertising-strategy](https://github.com/luotwo/BSC-amazon-advertising-strategy) — 面向 Amazon 卖家的广告策略 skill，生成可执行投放方案 🅰️🇨🇳🆓 _By [@luotwo](https://github.com/luotwo)_
...
* [amazon-reviews](https://github.com/luotwo/amazon-reviews) — Sorftime MCP 评论分析 + lark-cli 发飞书文档报告 🅰️🪶🇨🇳💎 _By [@luotwo](https://github.com/luotwo)_
...
* [BSC-Amazon-OPC-Agent-OS](https://github.com/luotwo/BSC-Amazon-OPC-Agent-OS) — BSC OPC Agent OS V2.0 — Amazon 产品运营综合 AI 工作台 🅰️🇨🇳🆓 _By [@luotwo](https://github.com/luotwo)_
...
**收录硬门槛**：公开 GitHub repo + 兼容 license（或作者在 README 公开声明开源）+ 含 `SKILL.md` 或同类清单 + README ≥200 字 + 近 6 个月有 commit + Amazon 跨境出海或 1688 供货落点。
...
### 中文社区
- 公众号：宝玉xp、歸藏的 AI 工具箱、AI 出海周报、Zach的进化笔记、WayToAIC
- 即刻圈子：AI 探索站、跨境电商人
